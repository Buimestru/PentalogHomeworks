...
Route::get('user/{id}', 'UserController@show')->middleware('auth:admin,web');
...
Route::get('createBorrowing/{user_id}', 'BorrowingController@create')->middleware('auth');

Route::post('storeBorrowing', 'BorrowingController@store')->middleware('auth');
...
Route::get('/notifications/{type}', 'NotificationController@index')->middleware('auth:admin,web');
